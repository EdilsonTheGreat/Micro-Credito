...
public class PagamentoService {
    ...
    public PagamentoService(PagamentoDAO pagamentoDAO, ListaDuplamenteLigada listaPagameto,
                            EmprestimoService emprestimoService, EmprestimoDAO emprestimoDAO, ClienteService clienteService) throws SQLException {
        ...
        public boolean registrarPagamento(String idEmprestimo, double valorPago) throws SQLException {
            ...
            if (valorPago < valorMinimo) {
                System.out.println("Valor insuficiente. Mínimo esperado: " + valorMinimo +
                        " (Valor sem atraso: " + valorSemAtraso +
                        ", Juro atraso: " + juroAtraso + ")");
                return false;
            }
       ...
       public void criarPlanoPagamento(String idEmprestimo){
        ...
        private int calcularProximaParcela(String idEmprestimo) throws SQLException {
        ...
        private void carregarPagamentosDaBase() throws SQLException {
