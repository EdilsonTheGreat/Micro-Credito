...
public class ClienteService {
    ...
    private ListaDuplamenteLigada listaCliente,  clientesBusca, ordenada;
    ...
    public ListaDuplamenteLigada buscarClientePorTelefoneApelido(int telefone, String apelido) {
        clientesBusca = new ListaDuplamenteLigada();
        ...
        for (int i = 0; i < listaCliente.tamanho(); i++) {
            ...
            if (cliente.getTelefone() == telefone &&
                ...
                clientesBusca.adcionaFim(cliente);
                encontrado = true;
            }
        }
...
private int clienteTemEmprestimosAtivos(String biCliente) {
    ...
    public ListaDuplamenteLigada getClientesBusca() {
        return clientesBusca;
    }
