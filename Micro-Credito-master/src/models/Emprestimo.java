...
public class Emprestimo {
    ...
    public String toString() {
        ...
        sb.append("  valorTotal=").append(valorEmprestado).append("\n");
        sb.append("  valor A Pagar=").append(valorAPagar).append("\n");
        sb.append("  tipo='").append(tipo).append("'\n");
        sb.append("  numeroPrestacoes=").append(numeroPrestacoes).append("\n");
        sb.append("  TAXA_JURO=").append(TAXA_JURO).append("%\n");
        sb.append("  estado='").append(estado).append("'\n");
        sb.append("  dataConcessao=").append(dataConcessao).append("\n");
